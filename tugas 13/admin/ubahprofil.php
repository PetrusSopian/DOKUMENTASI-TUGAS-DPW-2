...
if (isset($_POST["ubah"])) 
{
	...
	$koneksi->query("UPDATE toko_baru SET namatoko='$nama', email='$email', telepon='$telepon', provinsi='$_POST[provinsi]', tipe='$tipe', distrik_id='$id_distrik', distrik='$distrik', alamat='$alamat', fotoprofil='$fototoko'");

	}
 	else{

 	$koneksi->query("UPDATE toko_baru SET namatoko='$nama', email='$email', telepon='$telepon', provinsi='$_POST[provinsi]', tipe='$tipe', distrik_id='$id_distrik', distrik='$distrik', alamat='$alamat'");
 	}
